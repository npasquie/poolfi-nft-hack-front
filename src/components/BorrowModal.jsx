  ...
  const ABI = [
    {
      inputs: [
        ...
        { internalType: "uint256", name: "borrowSPR", type: "uint256" },
        { internalType: "contract IERC721[]", name: "collections", type: "address[]" },
        { internalType: "uint256[]", name: "_assetPrices", type: "uint256[]" },
      ],
      stateMutability: "nonpayable",
      type: "constructor",
    },
    { inputs: [], name: "AuctionNotYetStarted", type: "error" },
    { inputs: [], name: "BorrowsAndRepaysAreClosed", type: "error" },
    {
      inputs: [{ internalType: "contract IERC721", name: "collection", type: "address" }],
      name: "CollectionNotWhitelisted",
      type: "error",
    },
    { inputs: [], name: "LiquidityNotYetUnlocked", type: "error" },
    {
      inputs: [{ internalType: "address", name: "sender", type: "address" }],
      name: "SenderIsNotTheBorrower",
      type: "error",
    },
    { inputs: [], name: "SuppliesAreClosed", type: "error" },
    {
      anonymous: false,
      inputs: [
    ...
    {
      inputs: [{ internalType: "contract IERC721", name: "", type: "address" }],
      name: "assetPrice",
      outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
      stateMutability: "view",
      type: "function",
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: "address", name: "borrowedBy", type: "address" },
      ],
      stateMutability: "view",
      type: "function",
    },
